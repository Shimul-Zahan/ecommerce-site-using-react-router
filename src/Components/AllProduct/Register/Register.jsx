...
const Register = () => {
    ...
    const handleCreateUsingEmail = (e) => {
        e.preventDefault();
        const email = e.target.email.value;
        const password = e.target.password.value;
        const confirmPassword = e.target.confirmPassword.value;
        // const cheekMark = e.target.terms;
        setError(null)
        ...
        // console.log(email, password, confirmPassword, cheekMark);
    ...
    return (
        <section className=" dark:bg-gray-900">
            <div className="flex max-h-[570px] flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                ...
                <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form className="space-y-4 md:space-y-6" onSubmit={handleCreateUsingEmail}>
                            <div>
                            ...
                            <button type="submit" className="w-full text-white btn btn-outline btn-secondary hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Create an account</button>
